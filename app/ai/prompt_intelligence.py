...
class PromptIntelligenceService:
        ...
        *,
        ...
        return " ".join(
            [
                ...
                "For carousel outputs, evaluate relevance against the user's actual objective, not loose thematic similarity. Every major slide topic must be traceable to a user-prompt concept, requirement, or expected outcome.",
                "For carousel outputs, brand context, business context, product context, historical content patterns, and template topics must not become primary slide topics unless the user explicitly asked for them.",
                "For carousel outputs, never place internal planning text, reasoning text, strategy notes, framework labels, validation notes, system guidance, template guidance, metadata keys, or content-generation instructions into headline, supporting_line, body, body_points, proof_points, stat_highlights, cta, or claim_evidence_pairs.",
                ...
                "For carousel outputs, prioritize educational depth over recommendations or promotion: explain why each point matters and avoid suggestions, actions, product/platform messaging, or promotional copy unless the user explicitly requested that objective.",
    ...
    def compose_generation_envelope(
        ...
        Relevance must be judged against the user's actual objective, not loose thematic similarity. Every major slide topic must be traceable to a concept, requirement, or expected outcome present in the user prompt.
        Brand context, business context, product context, historical content patterns, and template topics may refine tone or examples, but they must not become primary slide topics unless explicitly requested by the user.
        Instruction leakage is forbidden: internal planning text, reasoning text, strategy notes, framework labels, validation notes, system guidance, template guidance, metadata keys, and content-generation instructions must never appear in headline, supporting_line, body, body_points, proof_points, stat_highlights, cta, or claim_evidence_pairs.
        ...
        Avoid repeating the same benefit, risk, or concept across slides unless the later slide adds new explanation, deeper reasoning, or a new perspective. Informational carousels must prioritize education over recommendations and promotion; suggestions, actions, product/platform messaging, or promotional copy belong only when the user explicitly asks for that objective.
