    ...
    def _content_metadata_schema_block() -> str:
        return "\n".join(
            [
                ...
                "- structured_visual_metadata.schema_version must be visual_metadata_v1",
                "- structured_visual_metadata.table_intent must include requested, allowed, requires_data_anchors, anchor_count, and source",
                "- structured_visual_metadata.chart_intent must include requested, allowed, numeric, requires_data_anchors, anchor_count, and source",
                "- structured_visual_metadata.data_anchors must contain only user-provided, verified, proof_point, stat_highlight, body_point, or claim_evidence text that can support a table/chart; use an empty list when none are approved",
                "- structured_visual_metadata.creativity_signals must include needs_attractive_visual, signals, and source; derive signals from user_prompt, brand visual context, visual_identity, visual knowledge, sample permissions, and existing metadata",
                "- structured_visual_metadata.visual_treatment_preference must include preferred, allowed, source, brand_asset_grounding, and layout_obedience; preferred can be 2d, 3d, isometric, flat_editorial, product_dashboard, icon_system, photo_composite, document_evidence, data_module, or brand_led",
